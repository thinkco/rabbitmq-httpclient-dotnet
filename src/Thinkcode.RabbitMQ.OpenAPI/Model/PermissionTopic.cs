...
namespace Thinkcode.RabbitMQ.OpenAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PermissionTopic :  IEquatable<PermissionTopic>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PermissionTopic" /> class.
        /// </summary>
        ...
        public PermissionTopic(string exchange = default(string), string read = default(string), string user = default(string), string vhost = default(string), string write = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PermissionTopic {\n");
        ...
        {
            return this.Equals(input as PermissionTopic);
        }

        /// <summary>
        /// Returns true if PermissionTopic instances are equal
        /// </summary>
        /// <param name="input">Instance of PermissionTopic to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PermissionTopic input)
        {
            if (input == null)
                return false;
